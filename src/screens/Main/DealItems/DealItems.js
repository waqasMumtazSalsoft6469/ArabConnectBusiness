...
import { marketplaceData, officeData, restaurants } from '../../../utils/dummyData';
...
const DealItems = ({ route }) => {
    ...
    return (
        <AppBackground
            ...
            notification
        >
            <View style={{ paddingHorizontal: 20, paddingVertical: 15, marginTop: 10, marginBottom: height * 0.07 }}>
