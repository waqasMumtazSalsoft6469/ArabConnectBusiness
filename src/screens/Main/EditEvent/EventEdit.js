...
import {useAddMutation, useEditMutation} from '../../../Api/EventsApiSlice';
...
const EventEdit = ({route}) => {
  ...
  const item = eventDetails?.eventDetails;
  LOG('Item: ', item);
  ...
  const handleSignup = async values => {
    ...
    LOG('Event Update Success:', response);
    ...
    <Formik
      ...
      {({
        ...
        <CustomBackground
          ...
          descriptionText={'Fill out this form to update event'}>
