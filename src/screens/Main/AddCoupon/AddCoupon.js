...
import {useAddMutation} from '../../../Api/couponApiSlice';
...
const AddCoupon = ({route}) => {
  ...
  const handleEdit = async values => {
    ...
    LOG('Coupon Record Add Success:', response);
    NavService.reset(0, [{name: 'MyCoupons'}]);
  };
  //   const jobTypeOptions = [
  //     {key: '1', value: 'Everyone'},
            ...
            <ScrollView
              ...
              <View
                ...
                {errors.selectOffer && touched.selectOffer && (
                  <Text style={[styles.error, {marginTop: -height * 0.003}]}>
                    {errors.selectOffer}
                  </Text>
                )}
              </View> */}
